...
| [Commands](https://github.com/d0whc3r/spec-kit-improve/wiki/Commands)                     | Deep reference for the `/speckit.improve.run` command.                   |
...
- **Never modifies source code itself.** The only writes go to `specs/improves/`; turning a prompt into code belongs to the spec-kit lifecycle, and merging is always yours.
